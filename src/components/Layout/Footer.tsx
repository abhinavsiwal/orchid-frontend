  ...
  return (
    <section className="flex flex-col lg:justify-end font-poppins">
      <div className="w-full bg-orange-900 pt-11 dark:bg-gray-900 ">
          ...
          <div className="flex flex-wrap items-center justify-between pb-4 border-b border-gray-500 dark:border-gray-700 lg:justify-between">
            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-full py-1 lg:w-auto lg:py-0">
                <button className="inline-block w-full px-5 py-4 font-medium leading-4 text-center bg-orange-200 rounded-md dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-orange-300">
                  Subscribe
                </button>
              </div>
            </div>
            ...
            <div className="w-full px-4 mb-11 md:w-1/2 lg:w-4/12 lg:mb-0">
              ...
              <div className="flex justify-start mt-4 ">
                <a
                  href="#"
                  type="button"
                  className="m-1 leading-normal text-gray-300 uppercase transition duration-150 ease-in-out border-2 border-gray-300 rounded-full dark:border-gray-400 dark:hover:bg-gray-800 hover:border-orange-700 hover:bg-orange-700 w-9 h-9"
                >
                  <svg
                ...
                <a
                  href="#"
                  type="button"
                  className="m-1 leading-normal text-gray-300 uppercase transition duration-150 ease-in-out border-2 border-gray-300 rounded-full dark:border-gray-400 dark:text-gray-400 dark:hover:bg-gray-800 hover:border-orange-500 hover:bg-orange-500 w-9 h-9"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={16}
                ...
                <a
                  href="#"
                  type="button"
                  className="m-1 leading-normal text-gray-400 uppercase transition duration-150 ease-in-out border-2 border-gray-300 rounded-full dark:border-gray-400 dark:text-gray-400 dark:hover:bg-gray-800 hover:border-orange-600 hover:bg-orange-600 w-9 h-9"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={16}
        ...
        <div className="py-5 text-center text-gray-200 bg-orange-800 dark:bg-gray-800 dark:text-gray-400">
